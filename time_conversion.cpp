...
std::string timeConversion( std::string s ) {
    ...
    char get_fHour = s[ 0 ];                                // hours have 2 integers  ( 0 <- 1st, 4 <- 2nd ) here is first
    ...
    std::string time("");                                   //add different strings into answer <- PM
...
int main() {
    ...
    std::string result = timeConversion(s);                 // function timeConversion()
